...
// || FUNCTION FOR GET WEATHER REPORT and weather API 
...
// || By default location those one will show on the first page 
weatherReport('Siwan Bihar');
...
// || Functions that will work foe the task
